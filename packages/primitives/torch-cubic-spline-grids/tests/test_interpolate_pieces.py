...
from torch_cubic_spline_grids import interpolate_pieces
...
def test_interpolate_pieces_1d_with_batched_queries():
    ...
    # cubic b spline interpolation should be equivalent to linear interpolation
...
def test_interpolate_pieces_1d_with_batched_pieces_and_queries():
    ...
    pieces = (
        torch.tensor([[0, 1, 2, 3], [2, 3, 4, 5]]).float().view(2, 1, 4)
    )  # (b, c, 4)
