...
def test_gaussian_2d_basic():
    ...
    center = dft_center(image_shape=(20, 20), rfft=False, fftshift=True)
...
@pytest.mark.parametrize("shape", [(20), (5, 5), (3, 2, 1, 2)])
...
def test_gaussian_3d_basic():
    ...
    center = dft_center(image_shape=(10, 10, 10), rfft=False, fftshift=True)
    grid = coordinate_grid(
...
@pytest.mark.parametrize("shape", [(10,), (4, 4), (2, 3, 2, 3)])
